...
void pe_body_add_contact(pe_body_t *body, struct pe_manifold_t *contact);
void pe_body_remove_contact(pe_body_t *body, struct pe_manifold_t *contact);
